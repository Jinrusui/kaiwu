...
class GameConfig:
    ...
    """
    这个weight可以较好的使agent的total reward随训练时间增加而有效增加（20h），但是训练HurtToHero的reward占比太大，agent
    倾向于频繁攻击英雄来获得奖励。所以下一阶段此reward奖励需下降
    ...
    REWARD_WEIGHT_DICT = {
        ...
        "HurtToOthers":0.08,
        'heal':0.4,
        'skill_hit_count':0.6,#0.01
        'useSkillToHero':0.03,
        'flash':0.6,
        'skill':0.015,
        'strengthen':0.1,
        'enemy_sodiler_hp':-0.001,
        'enemy_sodiler_pos':0.05,
        "attack_tower": 0.2,
        "defend_tower": 0.005,
        "approach_tower": 0.0006,
        'retreat':0.00007,
        "game_status":0.009,
        "skill_hit_count_bonus":0.6,
       }
